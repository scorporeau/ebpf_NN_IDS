...
\begin{abstract}
    ...
    %new things written, IDK where to put them so here Now
...
%The 4-histograms dissapeared ??? re-writing it ...
%TODO maybe replace with a box histogram showing all time_total in one graphics
\begin{figure*}[t]
    \caption{Comparison of the time passed in eBPF script per packet} \label{fig:results1}
    \centering
    \begin{minipage}{0.48\linewidth}
        \centering
        \def\svgwidth{\linewidth}
        \input{graphics/net_listener_tc_gro_off_time_total.pdf_tex}
        \caption{TC, gro off}
    \end{minipage}
    \begin{minipage}{0.48\linewidth}
        \centering
        \def\svgwidth{\linewidth}
        \input{graphics/net_listener_tc_gro_on_time_total.pdf_tex}
        \caption{TC, gro on}
    \end{minipage}
    \vspace{0.5em}
        ...
        \centering
        \def\svgwidth{\linewidth}
        \input{graphics/net_listener_xdp_gro_off_time_total.pdf_tex}
        \caption{XDP, gro off}
    \end{minipage}
    \begin{minipage}{0.48\linewidth}
        \centering
        \def\svgwidth{\linewidth}
        \input{graphics/net_listener_xdp_gro_on_time_total.pdf_tex}
        \caption{XDP, gro on}
    \end{minipage}
\end{figure*}
